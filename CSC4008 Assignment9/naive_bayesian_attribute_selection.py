...
def main():
    ...
    attribute_name.remove('employment')
    attribute_name.remove('credit_amount')
    attribute_continuous_name.remove('credit_amount')
    attribute_name.remove('age')
    attribute_continuous_name.remove('age')
    attribute_name.remove('existing_credits')
    attribute_continuous_name.remove('existing_credits')
    attribute_name.remove('property_magnitude')
    attribute_name.remove('other_payment_plans')
